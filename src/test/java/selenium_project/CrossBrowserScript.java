...
System.setProperty("webdriver.gecko.driver","C:\\Users\\pravithaas\\eclipse-workspace-selenium\\seleniumproject\\driver\\geckodriver.exe");
...
//dashboard
    ...
    WebElement photo = driver.findElement(By.xpath("//form[@id='frmUploadImage']/fieldset/ol/li[2]/input")); 
        ...
        photo.sendKeys("C:\\Users\\pravithaas\\Pictures\\Screenshots\\completed.png");//photo or file location 
